...
function graph_col_bt0(G::Vector{Vector{Int}},maxcol::Int;maxpaint=10^8) # max number of colors
...
function graph_col_bt0(G::Graph,maxcol::Int) # max number of colors
  ...
  found,color=graph_col_bt0(GG,maxcol)
  if found
